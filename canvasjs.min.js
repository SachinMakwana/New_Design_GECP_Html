...
1*m);return h}function W(h,m){var v=!1;0>h&&(v=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return v?"-"+h:h}function Ga(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,v=h.length;m.test(h.charAt(--v)););return h.slice(0,v+1)}function Ca(h){h.roundRect=function(h,v,s,w,pa,F,x,E){x&&(this.fillStyle=x);E&&(this.strokeStyle=E);"undefined"===typeof pa&&(pa=5);this.lineWidth=F;this.beginPath();this.moveTo(h+pa,v);this.lineTo(h+s-pa,v);this.quadraticCurveTo(h+s,v,h+s,v+pa);this.lineTo(h+s,
v+w-pa);this.quadraticCurveTo(h+s,v+w,h+s-pa,v+w);this.lineTo(h+pa,v+w);this.quadraticCurveTo(h,v+w,h,v+w-pa);this.lineTo(h,v+pa);this.quadraticCurveTo(h,v,h+pa,v);this.closePath();x&&this.fill();E&&0<F&&this.stroke()}}function Ra(h,m){return h-m}function R(h){var m=((h&16711680)>>16).toString(16),v=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;v=2>v.length?"0"+v:v;h=2>h.length?"0"+h:h;return"#"+m+v+h}function fb(h,m){var v=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=v);s<v;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Da(h){h.indexOf||(h.indexOf=fb);return h}function gb(h){if(J.fSDec)h[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){J._fTWm&&J._fTWm(h)})}function Ya(h,m,v){v=v||"normal";var s=h+"_"+m+"_"+v,w=Za[s];if(isNaN(w)){try{if(!va){var pa=document.body;va=document.createElement("span");va.innerHTML="";var F=document.createTextNode("Mpgyi");va.appendChild(F);
pa.appendChild(va)}va.style.display="";U(va,{position:"absolute",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:v});w=Math.round(va.offsetHeight);va.style.display="none"}catch(x){w=Math.ceil(1.1*m)}w=Math.max(w,m);Za[s]=w}return w}function O(h,m){var v=[];if(v={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,
2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<v.length;s++)v[s]*=m;else v=[];return v}function Q(h,m,v,w,sa){w=w||[];sa=s(sa)?hb?{passive:!1,capture:!1}:!1:sa;w.push([h,m,v,sa]);return h.addEventListener?(h.addEventListener(m,v,sa),v):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};v.call(h,m)},h.attachEvent("on"+m,w),w):!1}function ib(h){if(h._menuButton)h.exportEnabled?
(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),La(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):ta(h._menuButton);else if(h.exportEnabled&&w){var m=!1;h._menuButton=document.createElement("button");ua(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);Q(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);Q(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||h._dropDownCloseTime&&500>=(new Date).getTime()-
h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);Q(h._menuButton,"mousemove",function(){m||(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&U(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);Q(h._menuButton,"mouseout",function(){m||(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,
...
textAlign:"left",lineHeight:"10px",backgroundColor:h.toolbar.itemBackgroundColor,boxShadow:"2px 2px 10px"+v}),h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),Q(h._dropdownMenu,"blur",function(){ta(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),v=document.createElement("div"),U(v,{padding:"12px 8px 12px 8px"}),v.innerHTML=h._cultureInfo.printText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),
Q(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),Q(v,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),Q(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),Q(v,"click",function(){h.print();ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),U(v,{padding:"12px 8px 12px 8px"}),
v.innerHTML=h._cultureInfo.saveJPGText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),Q(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),Q(v,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),Q(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},
h.allDOMEventHandlers,!0),Q(v,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),U(v,{padding:"12px 8px 12px 8px"}),v.innerHTML=h._cultureInfo.savePNGText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),Q(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),Q(v,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),Q(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),Q(v,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function $a(h,m,v){h*=ja;m*=ja;h=v.getImageData(h,m,2,2).data;m=!0;for(v=0;4>v;v++)if(h[v]!==h[v+4]|h[v]!==h[v+8]|h[v]!==h[v+12]){m=!1;break}return m?
h[0]<<16|h[1]<<8|h[2]:0}function ka(h,m,v){return h in m?m[h]:v[h]}function Ma(h,m,v){if(w&&ab){var s=h.getContext("2d");Na=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ja=Sa/Na;h.width=m*ja;h.height=v*ja;Sa!==Na&&(h.style.width=m+"px",h.style.height=v+"px",s.scale(ja,ja))}else h.width=m,h.height=v}function jb(h){if(!kb){var m=!1,v=!1;"undefined"===typeof oa.Chart.creditHref?(h.creditHref=ga("iuuqr;..b`ow`rkr/bnl."),
h.creditText=ga("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),v=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),U(h._creditLink,{outline:"none",margin:"0px",position:"absolute",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));if(0===h.renderCount||m||v)h._creditLink.setAttribute("href",h.creditHref),h._creditLink.innerHTML=h.creditText;h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function ra(h,m){Ha&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
...
v&&(m.setAttribute("state",v),m.setAttribute("type","button"),U(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[v+"Text"]),m.innerHTML="<img src='"+lb[v].image+"' alt='"+h._cultureInfo[v+"Text"]+"' />",U(m.childNodes[0],{height:"95%",pointerEvents:"none"}))}function La(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ta(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Ta(h,m,v,s,w){if(null===h||"undefined"===typeof h)return"undefined"===typeof v?m:v;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof w&&(h=Math.max(w,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof v?m:v}function Z(h,m,v,w,x){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=x;this._eventListeners=[];
h={};this.theme&&s(this.parent)&&s(m)&&s(w)?h=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===w?h=this.parent.themeOptions[m]:0<this.parent.themeOptions[m].length&&(w=Math.min(this.parent.themeOptions[m].length-1,w),h=this.parent.themeOptions[m][w]));this.themeOptions=h;this.options=v?v:{_isPlaceholder:!0};this.setOptions(this.options,h)}function Ea(h,m,v,s,w){"undefined"===
typeof w&&(w=0);this._padding=w;this._x1=h;this._y1=m;this._x2=v;this._y2=s;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ha(h,m){ha.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ua(h,m){Ua.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function ya(h,m){ya.base.constructor.call(this,
...
[]}function Ja(h){var m;h&&Ka[h]&&(m=Ka[h]);Ja.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ha=!1,J={},w=!!document.createElement("canvas").getContext,oa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",rangeChanging:null,
...
H,ba,T,fa,X;ba="#333333";T="#000000";H="#666666";X=fa="#000000";var V=20,E=14,Wa={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Fa,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:E,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:ba,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:ba,
titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:ba,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:ba,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:ba,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,
labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],legend:{fontFamily:x,fontSize:14,fontColor:ba,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};T=ba="#F5F5F5";H="#FFFFFF";fa="#40BAF1";X="#F5F5F5";var V=20,E=14,bb={colorSet:"colorSet2",title:{fontFamily:x,
fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:E,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",
...
lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",
...
fa="#40BAF1";X="#F5F5F5";V=20;E=14;Fa={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Fa,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:E,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,indexLabelFontSize:E,
indexLabelFontColor:T,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,
labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:ba,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:T,backgroundColor:"rgba(0, 0, 0, .7)"}};H="#FFFFFF";T=ba="#FAFAFA";fa="#40BAF1";X="#F5F5F5";
var V=20,E=14,cb={light1:Wa,light2:bb,dark1:Fa,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:x,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:E,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,
indexLabelFontSize:E,indexLabelFontColor:T,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,
labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:fa,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",
...
m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),v="Sun Mon Tue Wed Thu Fri Sat".split(" "),s="January February March April May June July August September October November December".split(" "),w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),x=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,F=/[^-+\dA-Z]/g;return function(E,O,N){var H=N?N.days:m,R=N?N.months:s,Q=N?N.shortDays:
v,S=N?N.shortMonths:w;N="";var J=!1;E=E&&E.getTime?E:E?new Date(E):new Date;if(isNaN(E))throw SyntaxError("invalid date");"UTC:"===O.slice(0,4)&&(O=O.slice(4),J=!0);N=J?"getUTC":"get";var U=E[N+"Date"](),L=E[N+"Day"](),$=E[N+"Month"](),a=E[N+"FullYear"](),d=E[N+"Hours"](),c=E[N+"Minutes"](),b=E[N+"Seconds"](),e=E[N+"Milliseconds"](),f=J?0:E.getTimezoneOffset();return N=O.replace(h,function(l){switch(l){case "D":return U;case "DD":return W(U,2);case "DDD":return Q[L];case "DDDD":return H[L];case "M":return $+
1;case "MM":return W($+1,2);case "MMM":return S[$];case "MMMM":return R[$];case "Y":return parseInt(String(a).slice(-2));case "YY":return W(String(a).slice(-2),2);case "YYY":return W(String(a).slice(-3),3);case "YYYY":return W(a,4);case "h":return d%12||12;case "hh":return W(d%12||12,2);case "H":return d;case "HH":return W(d,2);case "m":return c;case "mm":return W(c,2);case "s":return b;case "ss":return W(b,2);case "f":return W(String(e),3).slice(0,1);case "ff":return W(String(e),3).slice(0,2);case "fff":return W(String(e),
3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(E).match(x)||[""]).pop().replace(F,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2)+W(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ca=function(h,m,v){if(null===h)return"";if(!isFinite(h))return h;
h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var w=v?v.decimalSeparator:".",x=v?v.digitGroupSeparator:",",F="";m=String(m);var F=1,E=v="",O=-1,N=[],H=[],R=0,J=0,Q=0,S=!1,U=0,E=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var L=0;E&&L<E.length;L++)if(m=E[L],"."===m&&0>O)O=L;else{if("%"===m)F*=100;else if("\u2030"===m){F*=1E3;continue}else if(","===m[0]&&"."===m[m.length-1]){F/=Math.pow(1E3,m.length-1);O=L+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(S=!0);
0>O?(N.push(m),"#"===m||"0"===m?R++:","===m&&Q++):(H.push(m),"#"!==m&&"0"!==m||J++)}S&&(m=Math.floor(h),E=-Math.floor(Math.log(h)/Math.LN10+1),U=0===h?0:0===m?-(R+E):String(m).length-R,F/=Math.pow(10,U));0>O&&(O=L);F=(h*F).toFixed(J);m=F.split(".");F=(m[0]+"").split("");h=(m[1]+"").split("");F&&"0"===F[0]&&F.shift();for(S=E=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===m)if(O++,O===R){var $=F,F=[];if("0"===m)for(m=R-J-($?$.length:0);0<m;)$.unshift("0"),m--;for(;0<$.length;)v=$.pop()+v,S++,0===S%
E&&(L===Q&&0<$.length)&&(v=x+v)}else 0<F.length?(v=F.pop()+v,J++,S++):"0"===m&&(v="0"+v,J++,S++),0===S%E&&(L===Q&&0<F.length)&&(v=x+v);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,E=S,S=0,0<F.length&&(v=x+v)):v=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+v:m+v:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),v+=m.replace(/[0]+/,function(a){return W(U,a.length)}));x="";for(N=!1;0<H.length;)m=
H.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(x+=h.shift(),N=!0):"0"===m&&(x+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?x+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?x+=m:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),x+=m.replace(/[0]+/,function(a){return W(U,a.length)}));v+=(N?w:"")+x;return s?"-"+v:v},Oa=function(h){var m=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?
(m=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,v=h.layerY):(m=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:m,y:v}},ab=!0,Sa=window.devicePixelRatio||1,Na=1,ja=ab?Sa/Na:1,da=function(h,m,v,s,w,x,F,E,O,N,S,R,H){"undefined"===typeof H&&(H=1);F=F||0;E=E||"black";var J=15<s-m&&15<w-v?8:0.35*Math.min(s-m,w-v);h.beginPath();h.moveTo(m,v);h.save();h.fillStyle=x;h.globalAlpha=H;h.fillRect(m,v,s-m,w-v);h.globalAlpha=1;0<F&&(H=0===F%2?0:0.5,h.beginPath(),h.lineWidth=F,h.strokeStyle=
E,h.moveTo(m,v),h.rect(m-H,v-H,s-m+2*H,w-v+2*H),h.stroke());h.restore();!0===O&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+J,v+J),h.lineTo(s-J,v+J),h.lineTo(s,v),h.closePath(),F=h.createLinearGradient((s+m)/2,v+J,(s+m)/2,v),F.addColorStop(0,x),F.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=F,h.fill(),h.restore());!0===N&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w-J),h.lineTo(s-J,w-J),h.lineTo(s,w),h.closePath(),F=h.createLinearGradient((s+m)/2,w-J,(s+m)/2,w),F.addColorStop(0,
x),F.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=F,h.fill(),h.restore());!0===S&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+J,v+J),h.lineTo(m+J,w-J),h.lineTo(m,w),h.closePath(),F=h.createLinearGradient(m+J,(w+v)/2,m,(w+v)/2),F.addColorStop(0,x),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=F,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(s,v),h.lineTo(s-J,v+J),h.lineTo(s-J,w-J),h.lineTo(s,w),F=h.createLinearGradient(s-J,(w+v)/2,s,(w+v)/2),F.addColorStop(0,
x),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=F,F.addColorStop(0,x),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=F,h.fill(),h.closePath(),h.restore())},ga=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},db=window&&window[ga("mnb`uhno")]&&window[ga("mnb`uhno")].href&&window[ga("mnb`uhno")].href.indexOf&&(-1!==window[ga("mnb`uhno")].href.indexOf(ga("b`ow`rkr/bnl"))||-1!==window[ga("mnb`uhno")].href.indexOf(ga("gdonqhy/bnl"))||
-1!==window[ga("mnb`uhno")].href.indexOf(ga("gheemd"))),kb=db&&-1===window[ga("mnb`uhno")].href.indexOf(ga("gheemd")),lb={reset:{image:"data:image/png;base64,"},
...
(function(){J.fSDec=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(h[s]-111);return m};J.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,231,143,178,208,219,216,209,225,216,155,143,187,228,210,216,211,208,143,182,225,208,221,211,212,155,143,187,228,210,216,211,208,143,194,208,221,226,143,196,221,216,210,222,211,212,155,143,176,225,216,208,219,155,143,226,208,221,226,156,226,212,225,216,213],tBl:[227,212,231,227,177,
208,226,212,219,216,221,212],fnt:[213,222,221,227],fSy:[213,216,219,219,194,227,232,219,212],fTx:[213,216,219,219,195,212,231,227],gr:[214,225,212,232],ct:[210,227,231],tp:[227,222,223]};delete oa[J.fSDec([178,215,208,225,227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])];J.pro={sCH:oa[J.fSDec([178,215,208,225,227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])]};J._fTWm=function(h){if("undefined"===typeof J.pro.sCH&&!db){var m=h[J.fSDec(J.str.ct)];m[J.fSDec(J.str.tBl)]=J.fSDec(J.str.tp);
m[J.fSDec(J.str.fnt)]=11+J.fSDec(J.str.fntStr);m[J.fSDec(J.str.fSy)]=J.fSDec(J.str.gr);m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv),2,h.height-11-2)}}})();Z.prototype.setOptions=function(h,m){if(oa[this._defaultsKey]){var s=oa[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:m&&w in m?m[w]:s[w])}else Ha&&window.console&&console.log("defaults not set")};Z.prototype.get=function(h){var m=oa[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?
null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};Z.prototype.set=function(h,m,s){s="undefined"===typeof s?!0:s;var w=oa[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),
this.options[h]=m;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}s&&(this.stockChart||this.chart||this).render()};Z.prototype.addTo=function(h,m,s,w){w="undefined"===typeof w?!0:w;var x=oa[this._defaultsKey];x.hasOwnProperty(h)||x.publicProperties&&x.publicProperties.hasOwnProperty(h)&&"readWrite"===
...
Z.prototype.createUserOptions=function(h){if("undefined"!==typeof h||this.options._isPlaceholder)if(this.parent.options._isPlaceholder&&this.parent.createUserOptions(),this.isOptionsInArray){this.parent.options[this.optionsName]||(this.parent.options[this.optionsName]=[]);var m=this.parent.options[this.optionsName],s=m.length;this.options._isPlaceholder||(Da(m),s=m.indexOf(this.options));this.options="undefined"===typeof h?{}:h;m[s]=this.options}else this.options="undefined"===typeof h?{}:h,h=this.parent.options,
this.optionsName?m=this.optionsName:(m=this._defaultsKey)&&0!==m.length?(s=m.charAt(0).toLowerCase(),1<m.length&&(s=s.concat(m.slice(1))),m=s):m=void 0,h[m]=this.options};Z.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Da(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};Z.prototype.updateOption=function(h){!oa[this._defaultsKey]&&
(Ha&&window.console)&&console.log("defaults not set");var m=oa[this._defaultsKey],w={},x=this[h],E=this._themeOptionsKey,J=this._index;this.theme&&s(this.parent)&&s(E)&&s(J)?w=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[E])&&(null===J?w=this.parent.themeOptions[E]:0<this.parent.themeOptions[E].length&&(w=Math.min(this.parent.themeOptions[E].length-1,J),w=this.parent.themeOptions[E][w]));
this.themeOptions=w;h in m&&(x=h in this.options?this.options[h]:w&&h in w?w[h]:m[h]);if(x===this[h])return!1;this[h]=x;return!0};Z.prototype.trackChanges=function(h){if(!this.sessionVariables)throw"Session Variable Store not set";this.sessionVariables[h]=this.options[h]};Z.prototype.isBeingTracked=function(h){this.options._oldOptions||(this.options._oldOptions={});return this.options._oldOptions[h]?!0:!1};Z.prototype.hasOptionChanged=function(h){if(!this.sessionVariables)throw"Session Variable Store not set";
return this.sessionVariables[h]!==this.options[h]};Z.prototype.addEventListener=function(h,m,s){h&&m&&(this._eventListeners[h]=this._eventListeners[h]||[],this._eventListeners[h].push({context:s||this,eventHandler:m}))};Z.prototype.removeEventListener=function(h,m){if(h&&m&&this._eventListeners[h])for(var s=this._eventListeners[h],w=0;w<s.length;w++)if(s[w].eventHandler===m){s[w].splice(w,1);break}};Z.prototype.removeAllEventListeners=function(){this._eventListeners=[]};Z.prototype.dispatchEvent=
function(h,m,s){if(h&&this._eventListeners[h]){m=m||{};for(var w=this._eventListeners[h],x=0;x<w.length;x++)w[x].eventHandler.call(w[x].context,m)}"function"===typeof this[h]&&this[h].call(s||this.chart,m)};Ea.prototype.registerSpace=function(h,m){"top"===h?this._topOccupied+=m.height:"bottom"===h?this._bottomOccupied+=m.height:"left"===h?this._leftOccupied+=m.width:"right"===h&&(this._rightOccupied+=m.width)};Ea.prototype.unRegisterSpace=function(h,m){"top"===h?this._topOccupied-=m.height:"bottom"===
...
this._topOccupied=this._padding};na(ha,Z);ha.prototype._initialize=function(){s(this.padding)||"object"!==typeof this.padding?this.topPadding=this.rightPadding=this.bottomPadding=this.leftPadding=Number(this.padding)|0:(this.topPadding=s(this.padding.top)?0:Number(this.padding.top)|0,this.rightPadding=s(this.padding.right)?0:Number(this.padding.right)|0,this.bottomPadding=s(this.padding.bottom)?0:Number(this.padding.bottom)|0,this.leftPadding=s(this.padding.left)?0:Number(this.padding.left)|0)};ha.prototype.render=
function(h){if(0!==this.fontSize){h&&this.ctx.save();var m=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var s=0;this._isDirty&&this.measureText(this.ctx);this.ctx.translate(this.x,this.y+s);"middle"===this.textBaseline&&(s=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var w=0,x=this.topPadding,E=null;this.ctx.roundRect||Ca(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,s,this.width,this.height,
this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(s=0;s<this._wrappedText.lines.length;s++){E=this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-E.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-E.width/2+this.leftPadding;
this.ctx.fillText(E.text,w,x);x+=E.height}this.ctx.font=m;h&&this.ctx.restore()}};ha.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=null};ha.prototype.measureText=function(){this._lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ha.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",
width:0};var w=s=0,x=h.length-1,E=Infinity;for(this.ctx.font=this._getFontString();w<=x;){var E=Math.floor((w+x)/2),F=h.substr(0,E+1);s=this.ctx.measureText(F).width;if(s<m)w=E+1;else if(s>m)x=E-1;else break}s>m&&1<F.length&&(F=F.substr(0,F.length-1),s=this.ctx.measureText(F).width);m=!0;if(F.length===h.length||" "===h[F.length])m=!1;m&&(h=F.split(" "),1<h.length&&h.pop(),F=h.join(" "),s=this.ctx.measureText(F).width);return{text:F,width:s}};ha.prototype._wrapText=function(){var h=new String(Ga(String(this.text))),
m=[],s=this.ctx.font,w=0,x=0;this.ctx.font=this._getFontString();if(0===this.frontSize)x=w=0;else for(;0<h.length;){var E=this.maxHeight-(this.topPadding+this.bottomPadding),F=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);F.height=this._lineHeight;m.push(F);var J=x,x=Math.max(x,F.width),w=w+F.height,h=Ga(h.slice(F.text.length,h.length));E&&w>E&&(F=m.pop(),w-=F.height,x=J)}this._wrappedText={lines:m,width:x,height:w};this.width=x+(this.leftPadding+this.rightPadding);
this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=s};ha.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};na(Ua,Z);na(ya,Z);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),
w=m.x1,x=m.y1,E=0,J=0,F=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,O,H;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-F*("center"===this.horizontalAlign?2:1)),J=0.5*m.height-this.margin-2,E=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),J=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===
this.maxWidth&&(this.maxWidth=m.width-4),J=0.5*m.height-4));var N;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==typeof this.padding||(N=this.padding.top?this.padding.top:this.padding.bottom?this.padding.bottom:0,N+=this.padding.bottom?this.padding.bottom:this.padding.top?this.padding.top:0):N=2*this.padding;this.wrap||(J=Math.min(J,1.5*this.fontSize+N));J=new ha(this.ctx,{fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,
...
"left"===this.horizontalAlign?w=m.x1+2:"center"===this.horizontalAlign?w=m.x1+m.width/2-N.width/2:"right"===this.horizontalAlign&&(w=m.x2-2-N.width-F),O=this.horizontalAlign,this.width=N.width,this.height=N.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(w=m.x1+2,x=m.y2-2-(this.maxWidth/2-N.width/2),E=-90,H="left",this.width=N.height,this.height=N.width):"right"===this.horizontalAlign?(w=m.x2-2,x=m.y1+2+(this.maxWidth/2-N.width/2),E=90,H="right",this.width=N.height,this.height=
N.width):"center"===this.horizontalAlign&&(x=h.y1+(h.height/2-N.height/2),w=h.x1+(h.width/2-N.width/2),H="center",this.width=N.width,this.height=N.height),O="center");J.x=w;J.y=x;J.angle=E;J.horizontalAlign=O;this._textBlock=J;h.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:w,y1:x,x2:w+this.width,y2:x+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&
this._textBlock.render(!0)};na(Ia,Z);Ia.prototype.setLayout=ya.prototype.setLayout;Ia.prototype.render=ya.prototype.render;Va.prototype.get=function(h,m){var s=null;0<this.pool.length?(s=this.pool.pop(),Ma(s,h,m)):s=ra(h,m);return s};Va.prototype.release=function(h){this.pool.push(h)};na(Ja,Z);var Pa={addTheme:function(h,m){cb[h]=m},addColorSet:function(h,m){za[h]=m},addCultureInfo:function(h,m){Ka[h]=m},formatNumber:function(h,m,s){s=s||"en";if(Ka[s])return ca(h,m||"#,##0.##",new Ja(s));throw"Unknown Culture Name";
},formatDate:function(h,m,s){s=s||"en";if(Ka[s])return Aa(h,m||"DD MMM YYYY",new Ja(s));throw"Unknown Culture Name";}};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=Pa:"function"===typeof define&&define.amd?define([],function(){return Pa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?
window.CanvasJS:Pa);x=Pa.Chart=function(){function h(a,d){return a.x-d.x}function m(a,d,c){d=d||{};s(c)?(this.predefinedThemes=cb,this.optionsName=this.parent=this.index=null):(this.parent=c.parent,this.index=c.index,this.predefinedThemes=c.predefinedThemes,this.optionsName=c.optionsName,this.stockChart=c.stockChart,this.panel=a,this.isOptionsInArray=c.isOptionsInArray);this.theme=s(d.theme)||s(this.predefinedThemes[d.theme])?"light1":d.theme;m.base.constructor.call(this,"Chart",this.optionsName,
...
[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var f,l,t;t=e-1;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[l].x-a[t].x?0.01:a[l].x-a[t].x))*(d-1)/2+1;var B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x+B/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>
a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x-B/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function x(a,d,c,b,e,f,l,t,B,k){var n=0;k?(l.color=f,t.color=f):k=1;n=B?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);B?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||f;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(O(t.dashType,
t.thickness));a.beginPath();B&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<t.thickness&&(a.moveTo(Math.round((d+b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(O(l.dashType,l.thickness));a.beginPath();B&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+
n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function E(a,d){E.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));
this.lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function H(a,d,c,b){H.base.constructor.call(this,"DataSeries","data",d,c,a);this.chart=a;this.canvas=a.canvas;this._ctx=a.canvas.ctx;this.index=c;this.noDataPointsInPlotArea=0;this.id=b;this.chart._eventManager.objectMap[b]={id:b,objectType:"dataSeries",dataSeriesIndex:c};a=d.dataPoints?d.dataPoints.length:0;this.dataPointEOs=[];for(d=0;d<a;d++)this.dataPointEOs[d]={};this.dataPointIds=[];this.plotUnit=
[];this.axisY=this.axisX=null;this.optionsName="data";this.isOptionsInArray=!0;null===this.fillOpacity&&(this.type.match(/area/i)?this.fillOpacity=0.7:this.fillOpacity=1);this.axisPlacement=this.getDefaultAxisPlacement();"undefined"===typeof this.options.indexLabelFontSize&&(this.indexLabelFontSize=this.chart.getAutoFontSize(this.indexLabelFontSize))}function F(a,d,c,b,e,f){F.base.constructor.call(this,"Axis",d,c,b,a);this.chart=a;this.canvas=a.canvas;this.ctx=a.ctx;this.intervalStartPosition=this.maxHeight=
...
180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360);this.options.scaleBreaks&&(this.scaleBreaks=new T(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new N(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new ba(this.chart,
...
this._appliedBreaks.splice(a,2),a--)}}function V(a,d,c,b,e,f){V.base.constructor.call(this,"Break",d,c,b,f);this.id=e;this.chart=a;this.ctx=this.chart.ctx;this.scaleBreaks=f;this.optionsName=d;this.isOptionsInArray=!0;this.type=c.type?this.type:f.type;this.fillOpacity=s(c.fillOpacity)?f.fillOpacity:this.fillOpacity;this.lineThickness=s(c.lineThickness)?f.lineThickness:this.lineThickness;this.color=c.color?this.color:f.color;this.lineColor=c.lineColor?this.lineColor:f.lineColor;this.lineDashType=c.lineDashType?
this.lineDashType:f.lineDashType;!s(this.startValue)&&this.startValue.getTime&&(this.startValue=this.startValue.getTime());!s(this.endValue)&&this.endValue.getTime&&(this.endValue=this.endValue.getTime());"number"===typeof this.startValue&&("number"===typeof this.endValue&&this.endValue<this.startValue)&&(a=this.startValue,this.startValue=this.endValue,this.endValue=a);this.spacing="undefined"===typeof c.spacing?f.spacing:c.spacing;"string"===typeof this.options.spacing?(this.spacing=parseFloat(this.spacing),
...
this.startValue.getTime():this.startValue)*(this.endValue.getTime?this.endValue.getTime():this.endValue)):((this.startValue.getTime?this.startValue.getTime():this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function ba(a,d,c){ba.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function W(a,d){W.base.constructor.call(this,"ToolTip",
"toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function fa(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ra(this.chart.width,
this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function X(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;this.animations=[];this.animationRequestId=null}na(m,Z);m.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&this._animator.cancelAllAnimations();this._panTimerId&&clearTimeout(this._panTimerId);for(var d=0;d<a.length;d++){var c=a[d][0],b=a[d][1],e=a[d][2],f=a[d][3],f=f||!1;c.removeEventListener?c.removeEventListener(b,
...
null;this.toolTip.container=null;this.canvas&&xa(this.canvas);this.overlaidCanvas&&xa(this.overlaidCanvas);this._preRenderCanvas&&xa(this._preRenderCanvas);this._breaksCanvas&&xa(this._breaksCanvas);this._eventManager&&this._eventManager.ghostCanvas&&xa(this._eventManager.ghostCanvas);this._toolBar=this._dropdownMenu=this._menuButton=this._resetButton=this._zoomButton=null};m.prototype._updateOptions=function(){var a=this;this.updateOption("width");this.updateOption("height");this.updateOption("dataPointWidth");
this.updateOption("dataPointMinWidth");this.updateOption("dataPointMaxWidth");this.updateOption("interactivityEnabled");this.updateOption("theme");this.updateOption("colorSet")&&(this.selectedColorSet="undefined"!==typeof za[this.colorSet]?za[this.colorSet]:za.colorSet1);this.updateOption("backgroundColor");this.backgroundColor||(this.backgroundColor="rgba(0,0,0,0)");this.updateOption("culture");this._cultureInfo=new Ja(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=
this.animationEnabled&&w;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Ua(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)U(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,
color:a.toolbar.fontColor}),this._zoomButton.title=this._cultureInfo.zoomText;else{var d=!1;ta(this._zoomButton=document.createElement("button"));ua(this,this._zoomButton,"pan");this._zoomButton.title=this._cultureInfo.panText;this._toolBar.appendChild(this._zoomButton);this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor;Q(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);Q(this._zoomButton,"click",function(){a.zoomEnabled?
(a.zoomEnabled=!1,a.panEnabled=!0,ua(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);Q(this._zoomButton,"mousemove",function(){d?d=!1:(U(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);
Q(this._zoomButton,"mouseout",function(){d||(U(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?(U(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),
this._resetButton.title=this._cultureInfo.resetText):(d=!1,ta(this._resetButton=document.createElement("button")),ua(this,this._resetButton,"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor,this._toolBar.appendChild(this._resetButton),Q(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),Q(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip&&a.toolTip.enabled&&a.toolTip.dispatchEvent("hidden",
{chart:a,toolTip:a.toolTip},a.toolTip);a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=null;if(a.sessionVariables.axisX2)for(b=0;b<a.sessionVariables.axisX2.length;b++)a.sessionVariables.axisX2[b].newViewportMinimum=
null,a.sessionVariables.axisX2[b].newViewportMaximum=null;if(a.sessionVariables.axisY)for(b=0;b<a.sessionVariables.axisY.length;b++)a.sessionVariables.axisY[b].newViewportMinimum=null,a.sessionVariables.axisY[b].newViewportMaximum=null;if(a.sessionVariables.axisY2)for(b=0;b<a.sessionVariables.axisY2.length;b++)a.sessionVariables.axisY2[b].newViewportMinimum=null,a.sessionVariables.axisY2[b].newViewportMaximum=null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],
{WebkitFilter:"invert(0%)",filter:"invert(0%)"});ta(a._zoomButton,a._resetButton);a.stockChart&&(a.stockChart._rangeEventParameter={stockChart:a.stockChart,source:"chart",index:a.stockChart.charts.indexOf(a),minimum:null,maximum:null});a._dispatchRangeEvent("rangeChanging","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanging",a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,a.stockChart));a.render();a.syncCharts&&a.syncCharts(null,null);a._dispatchRangeEvent("rangeChanged",
"reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),Q(this._resetButton,"mousemove",function(){d||(U(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},
this.allDOMEventHandlers),Q(this._resetButton,"mouseout",function(){d||(U(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?
...
ja||this.canvas.height!==c*ja){for(var b=0;b<a.length;b++)Ma(a[b],d,c);this.bounds={x1:0,y1:0,x2:this.width,y2:this.height,width:this.width,height:this.height};a=!0}else a=!1;return a};m.prototype._initialize=function(){this.isNavigator=s(this.parent)||s(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this._animator?this._animator.cancelAllAnimations():this._animator=new X(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=
...
this._axes.push(this.axisY2[0]=new F(this,"axisY2",this.options.axisY2,0,"axisY","top"))),this.data[d].axisY=this.axisY2[0],this.axisY2[0].dataSeries.push(this.data[d]);if(!this.data[d].axisXType||"primary"===this.data[d].axisXType)if(this.options.axisX&&0<this.options.axisX.length){if(!this.axisX.length)for(c=0;c<this.options.axisX.length;c++)"normal"===this.plotInfo.axisPlacement?this._axes.push(this.axisX[c]=new F(this,"axisX",this.options.axisX[c],c,"axisX","bottom")):"xySwapped"===this.plotInfo.axisPlacement&&
this._axes.push(this.axisX[c]=new F(this,"axisX",this.options.axisX[c],c,"axisX","left"));this.data[d].axisX=this.axisX[0<=this.data[d].axisXIndex&&this.data[d].axisXIndex<this.axisX.length?this.data[d].axisXIndex:0];this.axisX[0<=this.data[d].axisXIndex&&this.data[d].axisXIndex<this.axisX.length?this.data[d].axisXIndex:0].dataSeries.push(this.data[d])}else this.axisX.length||("normal"===this.plotInfo.axisPlacement?this._axes.push(this.axisX[0]=new F(this,"axisX",this.options.axisX,0,"axisX","bottom")):
"xySwapped"===this.plotInfo.axisPlacement&&this._axes.push(this.axisX[0]=new F(this,"axisX",this.options.axisX,0,"axisX","left"))),this.data[d].axisX=this.axisX[0],this.axisX[0].dataSeries.push(this.data[d]);if("secondary"===this.data[d].axisXType)if(this.options.axisX2&&0<this.options.axisX2.length){if(!this.axisX2.length)for(c=0;c<this.options.axisX2.length;c++)"normal"===this.plotInfo.axisPlacement?this._axes.push(this.axisX2[c]=new F(this,"axisX2",this.options.axisX2[c],c,"axisX","top")):"xySwapped"===
this.plotInfo.axisPlacement&&this._axes.push(this.axisX2[c]=new F(this,"axisX2",this.options.axisX2[c],c,"axisX","right"));this.data[d].axisX=this.axisX2[0<=this.data[d].axisXIndex&&this.data[d].axisXIndex<this.axisX2.length?this.data[d].axisXIndex:0];this.axisX2[0<=this.data[d].axisXIndex&&this.data[d].axisXIndex<this.axisX2.length?this.data[d].axisXIndex:0].dataSeries.push(this.data[d])}else this.axisX2.length||("normal"===this.plotInfo.axisPlacement?this._axes.push(this.axisX2[0]=new F(this,"axisX2",
...
this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor):(ta(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));gb(this);this._processData();this.options.title&&(this.title=new ya(this,this.options.title),
this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Ia(this,this.options.subtitles[d],d),this.subtitles.push(c),c.dockInsidePlotArea?a.push(c):c.setLayout();this.legend=new E(this,this.options.legend);for(d=0;d<this.data.length;d++)(this.data[d].showInLegend||"pie"===this.data[d].type||"doughnut"===this.data[d].type||"funnel"===this.data[d].type||"pyramid"===this.data[d].type)&&this.legend.dataSeries.push(this.data[d]);
...
"xySwapped"!==this.plotInfo.axisPlacement||F.setLayout(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement,this.layoutManager.getFreeSpace())};m.prototype.renderElements=function(){var a=this._plotAreaElements;this.title&&!this.title.dockInsidePlotArea&&this.title.render();for(var d=0;d<this.subtitles.length;d++)this.subtitles[d].dockInsidePlotArea||this.subtitles[d].render();this.legend.dockInsidePlotArea||this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===
this.plotInfo.axisPlacement)F.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ra(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}jb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=3;w&&this._breaksCanvas&&(this._preRenderCtx.drawImage(this.canvas,
0,0,this.width,this.height),this._preRenderCtx.drawImage(this._breaksCanvas,0,0,this.width,this.height),this._breaksCanvasCtx.globalCompositeOperation="source-atop",this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),this._preRenderCtx.clearRect(0,0,this.width,this.height));for(d=0;d<this.plotInfo.plotTypes.length;d++)for(var f=this.plotInfo.plotTypes[d],l=0;l<f.plotUnits.length;l++){var t=f.plotUnits[l],B=null;t.targetCanvas&&xa(t.targetCanvas);t.targetCanvas=null;this.animatedRender&&
(t.targetCanvas=ra(this.width,this.height),t.targetCanvasCtx=t.targetCanvas.getContext("2d"),e=t.targetCanvasCtx.miterLimit,t.targetCanvasCtx.miterLimit=3);"line"===t.type?B=this.renderLine(t):"stepLine"===t.type?B=this.renderStepLine(t):"spline"===t.type?B=this.renderSpline(t):"column"===t.type?B=this.renderColumn(t):"bar"===t.type?B=this.renderBar(t):"area"===t.type?B=this.renderArea(t):"stepArea"===t.type?B=this.renderStepArea(t):"splineArea"===t.type?B=this.renderSplineArea(t):"stackedColumn"===
...
"",d=0;d<this.data.length;d++)if(a=this.data[d],a.dataPoints&&(0!==a.dataPoints.length&&a.visible)&&0<=m._supportedChartTypes.indexOf(a.type)){for(var c=null,b=!1,e=null,f=!1,l=0;l<this.plotInfo.plotTypes.length;l++)if(this.plotInfo.plotTypes[l].type===a.type){b=!0;c=this.plotInfo.plotTypes[l];break}b||(c={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(c));for(l=0;l<c.plotUnits.length;l++)if(c.plotUnits[l].axisYType===a.axisYType&&c.plotUnits[l].axisXType===a.axisXType&&
...
(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==t.dataPoints[B-1].y&&(a.axisY.logarithmic?(r=e/t.dataPoints[B-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-t.dataPoints[B-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===
b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}t.axisX.valueType=t.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],t=[],B=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||
"xySwapped"===p.axisPlacement)var Qa=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,u=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?
this.options.axisX.maximum:Infinity;if(p.dataPoints[q].x&&p.dataPoints[q].x.getTime||"dateTime"===p.xValueType)f=!0;for(q=0;q<p.dataPoints.length;q++){"undefined"===typeof p.dataPoints[q].x&&(p.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));p.dataPoints[q].x.getTime?(f=!0,b=p.dataPoints[q].x.getTime()):b=p.dataPoints[q].x;e=s(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var m=b/p.dataPoints[q-1].x;1>m&&(m=1/m);c.minDiff>m&&1!==m&&(c.minDiff=
m)}else m=b-p.dataPoints[q-1].x,0>m&&(m*=-1),c.minDiff>m&&0!==m&&(c.minDiff=m);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(m=e/p.dataPoints[q-1].y,1>m&&(m=1/m),d.minDiff>m&&1!==m&&(d.minDiff=m)):(m=e-p.dataPoints[q-1].y,0>m&&(m*=-1),d.minDiff>m&&0!==m&&(d.minDiff=m)))}if(b<Qa&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=
...
0;p<n.dataPoints.length;p++){"undefined"===typeof n.dataPoints[p].x&&(n.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));n.dataPoints[p].x.getTime?(f=!0,b=n.dataPoints[p].x.getTime()):b=n.dataPoints[p].x;e=s(n.dataPoints[p].y)?null:n.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=b/n.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-n.dataPoints[p-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);s(e)||null===n.dataPoints[p-1].y||
(a.axisY.logarithmic?0<e&&(u=e/n.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-n.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:
0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!t?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&
...
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(k.dataPoints[n].x&&k.dataPoints[n].x.getTime||"dateTime"===k.xValueType)t=!0;for(n=0;n<k.dataPoints.length;n++){"undefined"===typeof k.dataPoints[n].x&&(k.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));k.dataPoints[n].x.getTime?(t=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var z=
0;z<e.length;z++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],
0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(z=0;z<e.length;z++)if(null===e[z]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=
...
(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[B].cumulativeSum-t.dataPointEOs[B-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<B&&(t.dataPointEOs[B-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[B-1].cumulativeSum),t.dataPointEOs[B-
...
n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(p=q[t],!s(p))){var g=Math.floor((p-B)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(p=-1*q[t],s(p)||(g=Math.floor((p-B)/b),p<n[g].min&&
(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(n=k[t].max,isFinite(n))for(;t<k.length-1;)if(B=k[t+1].min,isFinite(B)){p=B-n;p>b&&f.push({diff:p,start:n,end:B});break}else t++;if(this._axes[l].scaleBreaks.customBreaks)for(t=0;t<this._axes[l].scaleBreaks.customBreaks.length;t++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[t].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[t].endValue||
...
m.prototype.clearCanvas=mb;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=Oa(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;case "touchend":case "MSPointerUp":var f=this._lastTouchData&&this._lastTouchData.time?
...
b=0,e=0,f=0,l=f=e=0,t=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ka("indexLabelFontSize",n.dataPoint,n.dataSeries),t=ka("indexLabelFontFamily",n.dataPoint,n.dataSeries),B=ka("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ka("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ka("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=ka("indexLabelWrap",n.dataPoint,n.dataSeries);var m=ka("indexLabelLineDashType",n.dataPoint,n.dataSeries),u=ka("indexLabelLineColor",n.dataPoint,n.dataSeries),z=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<z?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,y={percent:null,total:null},C=null;if(0<=n.dataSeries.type.indexOf("stacked")||
...
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))y="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===y&&(y="inside");else if("bubble"===p||"scatter"===p)y="inside";q=n.point.x-("horizontal"===C?B/2:B/2-r/2);"inside"!==y?(e=c.y1,f=c.y2,0<v?(g=n.point.y+("horizontal"===C?r/2:0)-k-t-b,g<e&&(g="auto"===y?Math.max(n.point.y,e)+r/2+t:e+r/2+t,x=g+k>n.point.y)):(g=n.point.y+r/2+t+b,g>f-k&&(g="auto"===y?Math.min(n.point.y,f)+r/2-k-t:f+r/2-k,x=g<n.point.y))):(e=Math.max(n.bounds.y1,
...
0<=p.indexOf("scatter")?(y="auto",l=4):0<=p.indexOf("stacked")?"auto"===y&&(y="inside"):"bubble"===p&&(y="inside"),g=n.point.y+r/2-k/2+t,"inside"!==y?(e=c.x1,f=c.x2,0>v?(q=n.point.x-("horizontal"===C?B:B-r/2)-l-b,q<e&&(q="auto"===y?Math.max(n.point.x,e)+l:e+l,x=q+B>n.point.x)):(q=n.point.x+("horizontal"===C?0:r/2)+l+b,q>f-B-l-b&&(q="auto"===y?Math.min(n.point.x,f)-("horizontal"===C?B:B/2)-l:f-B-l,x=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===
p?0>v?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-B/2-l+("horizontal"===C?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===C?0:r/2),q=0>v?Math.max(n.point.x,b)-("horizontal"===C?B/2:0):Math.min(n.point.x,b)-B/2,q=Math.max(q,e));"vertical"===C&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);z&&("inside"!==y&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&n.point.x>c.x1&&n.point.x<c.x2||!x)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&
n.point.y<c.y2||!x))&&(d.lineWidth=z,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(O(m,z)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:B+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-t):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===C?(g-k<n.point.y?0:-k)+t:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===
...
dataSeriesIndex:B};r=R(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,z,s;c.beginPath();if(0<n.length){for(var C=!1,u=0;u<n.length;u++)if(z=n[u].x.getTime?n[u].x.getTime():n[u].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[u].y)0<u&&!(k.connectNullData||C||m)&&(c.stroke(),w&&b.stroke()),C=
!0;else{z=a.axisX.convertValueToPixel(z);s=a.axisY.convertValueToPixel(n[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:z,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(z,s),w&&b.lineTo(z,s)):(c.beginPath(),c.moveTo(z,s),w&&(b.beginPath(),
b.moveTo(z,s))),C=m=!1):(c.lineTo(z,s),w&&b.lineTo(z,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(z,s),w&&(b.stroke(),b.beginPath(),b.moveTo(z,s))));l={x:z,y:s};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(z,s),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize){var A=k.getMarkerProperties(u,
z,s,c);f.push(A);D=R(D);w&&f.push({x:z,y:s,ctx:b,type:A.type,size:A.size,color:D,borderColor:D,borderThickness:A.borderThickness})}(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[u],dataSeries:k,point:{x:z,y:s},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}$.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,s,y;c.beginPath();if(0<n.length){for(var C=!1,u=0;u<n.length;u++)if(s=n[u].getTime?n[u].x.getTime():n[u].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[u].y)0<
u&&!(k.connectNullData||C||m)&&(c.stroke(),w&&b.stroke()),C=!0;else{var D=y;s=a.axisX.convertValueToPixel(s);y=a.axisY.convertValueToPixel(n[u].y);var A=k.dataPointIds[u];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:s,y1:y};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(s,D),c.lineTo(s,y),w&&(b.lineTo(s,D),b.lineTo(s,y))):(c.beginPath(),c.moveTo(s,y),w&&(b.beginPath(),b.moveTo(s,y))),C=m=!1):(c.lineTo(s,D),w&&b.lineTo(s,D),c.lineTo(s,y),w&&b.lineTo(s,y),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(s,y),w&&(b.stroke(),b.beginPath(),b.moveTo(s,y))));l={x:s,y:y};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(s,y),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,
c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,s,y,c),f.push(D),A=R(A),w&&f.push({x:s,y:y,ctx:b,type:D.type,size:D.size,color:A,borderColor:A,borderThickness:D.borderThickness});(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[u],dataSeries:k,point:{x:s,y:y},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,u,s,y=[];b.beginPath();if(0<n.length)for(s=!1,m=0;m<n.length;m++)if(u=n[m].getTime?n[m].x.getTime():n[m].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!s)))if("number"!==typeof n[m].y)0<m&&!s&&(k.connectNullData?b.setLineDash&&(0<y.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(y[y.length-1].newLineDashArray=q,p=k.nullDataLineDashType):
(d(y),y=[])),s=!0;else{u=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(n[m].y);var C=k.dataPointIds[m];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:m,x1:u,y1:s};y[y.length]={x:u,y:s};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,y[y.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,y[y.length-1].newLineDashArray=O(p,k.lineThickness)):(p=k.lineDashType,
y[y.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var D=k.getMarkerProperties(m,u,s,b);l.push(D);C=R(C);w&&l.push({x:u,y:s,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:u,y:s},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});s=!1}d(y)}$.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,
...
B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];da(c,a.axisX.reversed?m:l,t,a.axisX.reversed?
l:m,u,b,0,null,h&&(a.axisY.reversed?0>r[f].y:0<=r[f].y),(a.axisY.reversed?0<=r[f].y:0>r[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:m,y2:u};b=R(b);w&&da(this._eventManager.ghostCtx,a.axisX.reversed?m:l,t,a.axisX.reversed?l:m,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],
dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,u),x2:m,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);var y=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=y+g<<0,D;if(a.axisY.logarithmic||
...
l[b]?l[b]:0,D=p+A,p=q+A,l[b]=A+(D-p);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];da(c,y,a.axisY.reversed?D:p,C,a.axisY.reversed?p:D,b,0,null,s&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:y,y1:p,x2:C,y2:D};b=R(b);w&&da(this._eventManager.ghostCtx,y,p,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||
...
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:
...
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],u=m.dataPoints;if(0<u.length)for(var s=5<g&&m.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?
...
animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,B,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
...
a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){t=a.axisX.convertValueToPixel(B);l=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+
n)*p<<0;var m=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];da(c,a.axisY.reversed?l:u,a.axisX.reversed?m:t,a.axisY.reversed?u:l,a.axisX.reversed?t:m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:m};b=R(b);w&&da(this._eventManager.ghostCtx,u,a.axisX.reversed?m:t,l,a.axisX.reversed?t:m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||
...
c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===
...
0<=u[k].y){var A=f[b]?f[b]:0;D=q+A;n+=A;f[b]=A+(n-D)}else A=l[b]?l[b]:0,D=n-A,n=q-A,l[b]=A+(n-D);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];da(c,a.axisY.reversed?n:D,y,a.axisY.reversed?D:n,C,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:y,x2:n,y2:C};b=R(b);w&&da(this._eventManager.ghostCtx,D,y,n,C,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||
...
this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var y;y=0!==a.dataPointYSums[b]?100*
...
f[b]?f[b]:0;y=q+A;n+=A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=A+(n-y)}else A=l[b]?l[b]:0,y=n-A,n=q-A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-y)&&(y=e.x1),l[b]=A+(n-y);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];da(c,a.axisY.reversed?n:y,C,a.axisY.reversed?y:n,D,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:y,y1:C,x2:n,y2:D};b=R(b);w&&da(this._eventManager.ghostCtx,
...
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=
...
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,m,u,s,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,D=null;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var K=O(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=O(c,g.lineThickness);f.setLineDash(aa)}for(var ia=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ia)))if("number"!==
typeof r[h].y)g.connectNullData||(ia||d)||b(),ia=!0;else{m=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[h].y);d||ia?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,D=n,c=g.nullDataLineDashType,f.setLineDash(K)),f.lineTo(m,u),w&&l.lineTo(m,u)):(f.beginPath(),f.moveTo(m,u),w&&(l.beginPath(),l.moveTo(m,u)),D={x:m,y:u}),ia=d=!1):(f.lineTo(m,u),w&&l.lineTo(m,
u),0==h%250&&b());n={x:m,y:u};h<r.length-1&&(x!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(O(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[h];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:u};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,
u,f),B.push(s),Y=R(Y),w&&B.push({x:m,y:u,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();$.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,
...
0;B<a.dataSeriesIndexes.length;B++){var k=a.dataSeriesIndexes[B],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=R(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,u=null,s=[];if(0<p.length){var y=n._colorSet[q%n._colorSet.length],C=n.lineColor=n.options.lineColor||y,D=C;b.fillStyle=y;b.strokeStyle=C;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=O(n.nullDataLineDashType,
n.lineThickness),A=n.lineDashType,F=O(A,n.lineThickness);b.setLineDash(F)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=x,A=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);
var K=n.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||A!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(A=p[q].lineDashType,s[s.length-1].newLineDashArray=O(A,n.lineThickness)):(A=n.lineDashType,s[s.length-1].newLineDashArray=F)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=
n.getMarkerProperties(q,g,r,b);l.push(aa);K=R(K);w&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:y});r=!1}d();$.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=y:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=y),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,u),l.beginPath(),l.moveTo(m,u),D={x:m,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,m,u,s,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;var K="solid";if(f.setLineDash){var aa=O(g.nullDataLineDashType,g.lineThickness),K=g.lineDashType,F=O(K,g.lineThickness);f.setLineDash(F)}for(;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=u;"number"!==
typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),u=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||K===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,D=n,K=g.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(m,Y),f.lineTo(m,u),w&&(l.lineTo(m,Y),l.lineTo(m,u))):(f.beginPath(),f.moveTo(m,u),w&&(l.beginPath(),l.moveTo(m,u)),D={x:m,y:u}),c=
d=!1):(f.lineTo(m,Y),w&&l.lineTo(m,Y),f.lineTo(m,u),w&&l.lineTo(m,u),0==h%250&&b()),n={x:m,y:u},h<r.length-1&&(x!==(r[h].lineColor||v)||K!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(K=r[h].lineDashType,f.setLineDash(O(K,g.lineThickness))):(K=g.lineDashType,f.setLineDash(F)))),s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:u},0!==r[h].markerSize&&(0<r[h].markerSize||
0<g.markerSize)&&(Y=g.getMarkerProperties(h,m,u,f),B.push(Y),s=R(s),w&&B.push({x:m,y:u,ctx:l,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:m,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A}))}b();$.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=
function(a){function d(){if(!(1>k.length)){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:
0),s=this._eventManager.ghostCtx,u,z,y;w&&s.beginPath();b.save();w&&s.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(s.beginPath(),s.rect(t.x1,t.y1,t.width,t.height),s.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],A=this.data[D],v=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Ra)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];
A=this.data[D];v=A.dataPoints;z=!0;k=[];q=A.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=R(q);s.fillStyle=q;if(0<n.length){var e=A._colorSet[0],x=A.lineColor=A.options.lineColor||e,K=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=A.lineThickness;y="solid";if(b.setLineDash){var aa=O(A.nullDataLineDashType,A.lineThickness);y=A.lineDashType;var F=O(y,A.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:
{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!Y)))if("number"!==typeof ea.y)A.connectNullData||(Y||z)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var la=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ea.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ea.y),r-=la;k.push({x:g,y:m-la});h[f]=m-r;z||Y?(!z&&
A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||y===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(z=k.pop(),y=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(y),k.push(z),y=A.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),s.moveTo(g,r))),Y=z=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:m-la})));u={x:g,y:r};q<v.length-1&&(K!==(v[q].lineColor||x)||y!==
(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-la}),K=v[q].lineColor||x,b.strokeStyle=K,b.setLineDash&&(v[q].lineDashType?(y=v[q].lineDashType,b.setLineDash(O(y,A.lineThickness))):(y=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var E=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&
(0<ea.markerSize||0<A.markerSize)&&(la=A.getMarkerProperties(A.dataPointIndexes[f],g,r,b),l.push(la),f=R(E),w&&l.push({x:g,y:r,ctx:s,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete A.dataPointIndexes}$.drawMarkers(l);
w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&y.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(y.closePath(),y.fill(),y.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],n=[],p=[],q=
0,g,r,m,s,u,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y=this._eventManager.ghostCtx;b.save();w&&y.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(y.beginPath(),y.rect(l.x1,l.y1,l.width,l.height),y.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],A=this.data[D],v=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=
!0);n.sort(Ra)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];A=this.data[D];v=A.dataPoints;s=!0;e=A.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:D};e=R(e);y.fillStyle=e;k=[];if(0<n.length){var e=A._colorSet[q%A._colorSet.length],x=A.lineColor=A.options.lineColor||e,K=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=A.lineThickness;u="solid";if(b.setLineDash){var aa=O(A.nullDataLineDashType,A.lineThickness);u=A.lineDashType;var F=O(u,A.lineThickness);
b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!Y)))if("number"!==typeof ea.y)A.connectNullData||(Y||s)||d(),Y=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var E=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=
la+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(la),r-=E;k.push({x:g,y:z-E});h[f]=z-r;s||Y?(!s&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||u===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(u),k.push(s),u=A.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&y.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(y.beginPath(),y.moveTo(g,
r))),Y=s=!1):(b.lineTo(g,r),w&&y.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&y.moveTo(g,r),k.push({x:g,y:z-E})));m={x:g,y:r};q<v.length-1&&(K!==(v[q].lineColor||x)||u!==(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:z-E}),K=v[q].lineColor||x,b.strokeStyle=K,b.setLineDash&&(v[q].lineDashType?(u=v[q].lineDashType,b.setLineDash(O(u,A.lineThickness))):(u=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var G=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[G]=
{id:G,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(E=A.getMarkerProperties(q,g,r,b),t.push(E),f=R(G),w&&t.push({x:g,y:r,ctx:y,type:E.type,size:E.size,color:f,borderColor:f,borderThickness:E.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:A,point:{x:g,y:r},
direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&y.moveTo(g,r)}delete A.dataPointIndexes}$.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
b.clearRect(l.x1,l.y1,l.width,l.height),y.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
...
r),k=0;k<a.dataSeriesIndexes.length;k++)if(n=a.dataSeriesIndexes[k],p=this.data[n],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,s=2*Math.max(Math.sqrt((t===h?m/2:r+(m-r)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=
p.fillOpacity;$.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:s};s=R(u);w&&$.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},
...
f,l,c);c.globalAlpha=k.fillOpacity;$.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=R(p),w&&$.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||
...
if(0<z.length)for(var y=5<r&&u.bevelEnabled?!0:!1,t=0;t<z.length;t++)if(z[t].getTime?g=z[t].x.getTime():g=z[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(z[t].y)&&z[t].y.length&&"number"===typeof z[t].y[0]&&"number"===typeof z[t].y[1]&&"number"===typeof z[t].y[2]&&"number"===typeof z[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(z[t].y[0]);n=a.axisY.convertValueToPixel(z[t].y[1]);p=a.axisY.convertValueToPixel(z[t].y[2]);q=a.axisY.convertValueToPixel(z[t].y[3]);
var C=h-r/2<<0,v=C+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=z[t].color?z[t].color:u._colorSet[0],A=Math.round(Math.max(1,0.15*r)),x=0===A%2?0:0.5,F=u.dataPointIds[t];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:Qa,dataPointIndex:t,x1:C,y1:k,x2:v,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:A,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=A;b.lineWidth=Math.max(A,4);"candlestick"===u.type?(c.moveTo(h-x,n),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-
x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),da(c,C,Math.min(k,q),v,Math.max(k,q),z[t].y[0]<=z[t].y[3]?u.risingColor:f,A,e,y,y,!1,!1,u.fillOpacity),w&&(e=R(F),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,Math.min(k,q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),da(b,C,Math.min(k,q),v,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-x,n),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(v,q),
c.stroke(),w&&(e=R(F),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(v,q),b.stroke()));(z[t].indexLabel||u.indexLabel||z[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:z[t],dataSeries:u,point:{x:C+(v-C)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:C,y1:Math.min(n,p),x2:v,y2:Math.max(n,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,
...
f.height);c.clip();w&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,v=0;v<a.dataSeriesIndexes.length;v++){var u=a.dataSeriesIndexes[v],z=this.data[u],y=z.dataPoints;if(0<y.length)for(var C=5<r&&z.bevelEnabled?!0:!1,l=0;l<y.length;l++)if(y[l].getTime?g=y[l].x.getTime():g=y[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(y[l].y)&&y[l].y.length&&"number"===typeof y[l].y[0]&&"number"===typeof y[l].y[1]&&"number"===typeof y[l].y[2]&&
"number"===typeof y[l].y[3]&&"number"===typeof y[l].y[4]&&5===y[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(y[l].y[0]);k=a.axisY.convertValueToPixel(y[l].y[1]);n=a.axisY.convertValueToPixel(y[l].y[2]);p=a.axisY.convertValueToPixel(y[l].y[3]);q=a.axisY.convertValueToPixel(y[l].y[4]);var D=t-r/2<<0,A=t+r/2<<0,e=y[l].color?y[l].color:z._colorSet[0],x=Math.round(Math.max(1,0.15*r)),F=0===x%2?0:0.5,K=y[l].whiskerColor?y[l].whiskerColor:y[l].color?z.whiskerColor?z.whiskerColor:
y[l].color:z.whiskerColor?z.whiskerColor:e,aa="number"===typeof y[l].whiskerThickness?y[l].whiskerThickness:"number"===typeof z.options.whiskerThickness?z.whiskerThickness:x,E=y[l].whiskerDashType?y[l].whiskerDashType:z.whiskerDashType,Y=s(y[l].whiskerLength)?s(z.options.whiskerLength)?r:z.whiskerLength:y[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>r?r:parseInt(Y)*r/100:r,ea=1===Math.round(aa)%2?0.5:0,la=y[l].stemColor?y[l].stemColor:y[l].color?z.stemColor?
z.stemColor:y[l].color:z.stemColor?z.stemColor:e,Ba="number"===typeof y[l].stemThickness?y[l].stemThickness:"number"===typeof z.options.stemThickness?z.stemThickness:x,G=1===Math.round(Ba)%2?0.5:0,J=y[l].stemDashType?y[l].stemDashType:z.stemDashType,H=y[l].lineColor?y[l].lineColor:y[l].color?z.lineColor?z.lineColor:y[l].color:z.lineColor?z.lineColor:e,N="number"===typeof y[l].lineThickness?y[l].lineThickness:"number"===typeof z.options.lineThickness?z.lineThickness:x,S=y[l].lineDashType?y[l].lineDashType:
z.lineDashType,M=1===Math.round(N)%2?0.5:0,Q=z.upperBoxColor,wa=z.lowerBoxColor,qa=s(z.options.fillOpacity)?1:z.fillOpacity,P=z.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:D,y1:h,x2:A,y2:k,x3:t,y3:n,x4:t,y4:p,y5:q,borderThickness:x,color:e,stemThickness:Ba,stemColor:la,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<Ba&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=Ba,c.setLineDash&&c.setLineDash(O(J,
Ba)),c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,n),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();da(c,D,Math.min(q,k),A,Math.max(k,q),wa,0,e,m?C:!1,m?!1:C,!1,!1,qa);c.beginPath();da(c,D,Math.min(n,q),A,Math.max(q,n),Q,0,e,m?!1:C,m?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(D-F,Math.min(k,n)-F,A-D+2*F,Math.max(k,n)-Math.min(k,n)+2*F);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(S,N)),c.strokeStyle=
H,c.lineWidth=N,c.moveTo(D,q-M),c.lineTo(A,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(E,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(t-Y/2<<0,p-ea),c.lineTo(t+Y/2<<0,p-ea),c.stroke(),c.moveTo(t-Y/2<<0,h+ea),c.lineTo(t+Y/2<<0,h+ea),c.stroke());c.restore();w&&(e=R(P),b.strokeStyle=e,b.lineWidth=Ba,0<Ba&&(b.moveTo(t-F-G,k),b.lineTo(t-F-G,Math.max(h,p)),b.stroke(),b.moveTo(t-F-G,Math.min(h,p)),b.lineTo(t-F-G,n),b.stroke()),da(b,D,Math.max(k,n),A,Math.min(k,
n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(t+Y/2,p-ea),b.lineTo(t-Y/2,p-ea),b.stroke(),b.moveTo(t+Y/2,h+ea),b.lineTo(t-Y/2,h+ea),b.stroke()));(y[l].indexLabel||z.indexLabel||y[l].indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:z.type,dataPoint:y[l],dataSeries:z,point:{x:D+(A-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,y1:Math.min(h,p),x2:A,y2:Math.max(h,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0,v=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:v,y2:t};da(c,a.axisX.reversed?
v:m,l,a.axisX.reversed?m:v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=R(u);w&&da(this._eventManager.ghostCtx,a.axisX.reversed?v:m,l,a.axisX.reversed?m:v,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(v-m)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
...
t=0,h,k,n,p,q,g,r,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var v=0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&v||v++;for(var z=0;z<
a.dataSeriesIndexes.length;z++){var y=a.dataSeriesIndexes[z],C=this.data[y],D=C.dataPoints,A=s(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,F=0;if(A)for(e=C._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&F||(this.data[u].type.match(/(range)/ig)&&(f=!0),F++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
...
Math.abs(m)/Math.abs(a.axisX.range))/(A?v:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>t&&(u=t);if(0<D.length)for(var E=C._colorSet,t=0;t<D.length;t++){var e=C.lineColor=C.options.color?C.options.color:E[0],K={color:D[t].whiskerColor?D[t].whiskerColor:D[t].color?C.whiskerColor?C.whiskerColor:D[t].color:
C.whiskerColor?C.whiskerColor:e,thickness:s(D[t].whiskerThickness)?C.whiskerThickness:D[t].whiskerThickness,dashType:D[t].whiskerDashType?D[t].whiskerDashType:C.whiskerDashType,length:s(D[t].whiskerLength)?s(C.options.whiskerLength)?u:C.options.whiskerLength:D[t].whiskerLength,trimLength:s(D[t].whiskerLength)?s(C.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=u?u:K.length:"string"===typeof K.length?parseInt(K.length)*u/100>u?u:parseInt(K.length)*u/100>u:
u;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):2;var aa={color:D[t].stemColor?D[t].stemColor:D[t].color?C.stemColor?C.stemColor:D[t].color:C.stemColor?C.stemColor:e,thickness:D[t].stemThickness?D[t].stemThickness:C.stemThickness,dashType:D[t].stemDashType?D[t].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[t].getTime?r=D[t].x.getTime():r=D[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&
!s(D[t].y)&&D[t].y.length&&"number"===typeof D[t].y[0]&&"number"===typeof D[t].y[1]){var ia=a.axisX.convertValueToPixel(r);b?k=ia:h=ia;ia=a.axisY.convertValueToPixel(D[t].y[0]);b?n=ia:q=ia;ia=a.axisY.convertValueToPixel(D[t].y[1]);b?p=ia:g=ia;b?(q=a.axisX.reversed?k+(A?v:1)*u/2-(A?F-1:0)*u<<0:k-(A?v:1)*u/2+(A?F-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(n=a.axisX.reversed?h+(A?v:1)*u/2-(A?F-1:0)*u<<0:h-(A?v:1)*u/2+(A?F-1:0)*u<<0,p=a.axisX.reversed?n-u<<0:n+u<<0);!b&&q>g&&(ia=q,q=g,g=ia);b&&n>p&&
(ia=n,n=p,p=ia);ia=C.dataPointIds[t];this._eventManager.objectMap[ia]={id:ia,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:t,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};x(c,Math.min(n,p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,K,aa,b);w&&x(this._eventManager.ghostCtx,n,q,p,g,e,K,aa,b);if(D[t].indexLabel||C.indexLabel||D[t].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",
...
l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,h,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?
...
n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var v=a.axisX.reversed?h-n<<0:h+n<<0;l>t&&(b=l,l=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];da(c,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:t,y2:v};b=R(b);w&&da(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(z){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=
h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,m);e.beginPath();e.moveTo(r,m);z={x:r,y:m};h=[];h.push({x:r,y1:m,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],
n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=R(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,u,z=null;if(0<p.length){var y=n._colorSet[g%n._colorSet.length],v=n.lineColor=n.options.lineColor||y,D=v;b.fillStyle=y;b.strokeStyle=v;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=O(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,F=O(A,n.lineThickness);b.setLineDash(F)}for(var K=!0;g<p.length;g++)if(u=p[g].x.getTime?
p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!K)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||K?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||A===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=F,A=n.nullDataLineDashType,
b.setLineDash(x)),b.lineTo(r,m),w&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),z={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),w&&(e.beginPath(),e.moveTo(r,m))),K=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),w&&e.lineTo(r,m),0==g%250&&d());u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-1&&(D!==(p[g].lineColor||v)||A!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||v,h[h.length-
1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(A=p[g].lineDashType,h[h.length-1].newLineDashArray=O(A,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(A=n.lineDashType,h[h.length-1].newLineDashArray=F,b.setLineDash(F))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,s,b);f.push(aa);var E=R(u);w&&f.push({x:r,y:s,ctx:e,type:aa.type,size:aa.size,color:E,borderColor:E,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,
r,m,b);f.push(aa);E=R(u);w&&f.push({x:r,y:m,ctx:e,type:aa.type,size:aa.size,color:E,borderColor:E,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:y}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>
p[g].y[1]===a.axisY.reversed?1:-1,color:y})}else K||q||d(),K=!0;d();$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=R(f);e.fillStyle=f;var f=[],p=0,q,
g,m,s=[],x=[];if(0<n.length){var u=k._colorSet[p%k._colorSet.length],z=k.lineColor=k.options.lineColor||u,y=z;b.fillStyle=u;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var A=O(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=O(C,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===
typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);m=a.axisY.convertValueToPixel(n[p].y[1]);var F=k.dataPointIds[p];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:m};s[s.length]={x:q,y:g};x[x.length]={x:q,y:m};p<n.length-1&&(y!==(n[p].lineColor||z)||C!==(n[p].lineDashType||k.lineDashType))&&(y=n[p].lineColor||z,s[s.length-1].newStrokeStyle=y,b.setLineDash&&(n[p].lineDashType?(C=n[p].lineDashType,
s[s.length-1].newLineDashArray=O(C,k.lineThickness)):(C=k.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(p,q,g,b);f.push(E);var K=R(F);w&&f.push({x:q,y:g,ctx:e,type:E.type,size:E.size,color:K,borderColor:K,borderThickness:E.borderThickness});E=k.getMarkerProperties(p,q,m,b);f.push(E);K=R(F);w&&f.push({x:q,y:m,ctx:e,type:E.type,size:E.size,color:K,borderColor:K,borderThickness:E.borderThickness})}if(n[p].indexLabel||
k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:m},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<s.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-
1].newLineDashArray=A,C=k.nullDataLineDashType):(d(D,z),s=[],x=[])),g=!0;d(D,z);$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
...
a.dataSeriesIndexes[g],s=this.data[r],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,z=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var y=5<q&&s.bevelEnabled?!0:!1,C=!1,D=null,A=null,l=0;l<v.length;l++)if(v[l].getTime?n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!C&&s.connectNullData)var x=
s.options.nullDataLineDashType||!v[l-1].lineDashType?s.nullDataLineDashType:v[l-1].lineDashType;C=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+
g)*q<<0;var F=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:F,y2:k};var K=v[l].color?v[l].color:0<v[l].y?s.risingColor:s.fallingColor;da(c,a.axisX.reversed?F:h,a.axisY.reversed?k:m,a.axisX.reversed?h:F,a.axisY.reversed?m:k,K,0,K,y,y,!1,!1,s.fillOpacity);e=R(e);w&&da(this._eventManager.ghostCtx,a.axisX.reversed?F:h,m,a.axisX.reversed?h:
F,k,e,0,null,!1,!1,!1,!1);var aa,K=h;aa="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?m:k:0<v[l].y?k:m;0<l&&D&&(!C||s.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(O(x,u)),c.beginPath(),c.moveTo(D,A-z),c.lineTo(K,aa-z),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(D,A-z),b.lineTo(K,aa-z),0<u&&b.stroke()));C=!1;D=F;A=0<v[l].y?m:k;K=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
...
3*Math.PI/2-u&&h.midAngle<3*Math.PI/2+u){if(0===b||g[d].midAngle>h.midAngle)d=e;b++}h.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";h.indexLabelTextBlock=new ha(m.plotArea.ctx,{fontSize:h.indexLabelFontSize,fontFamily:h.indexLabelFontFamily,fontColor:h.indexLabelFontColor,fontStyle:h.indexLabelFontStyle,fontWeight:h.indexLabelFontWeight,textAlign:h.indexLabelTextAlign,backgroundColor:h.indexLabelBackgroundColor,maxWidth:h.indexLabelMaxWidth,maxHeight:h.indexLabelWrap?5*h.indexLabelFontSize:
...
g[a];h.indexLabelTextBlock.x=y.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=y.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=A;h.percentInnerRadius=F}for(var t,s,a=0;a<n.length;a++){var h=g[a],u=e(a);if(null!==u){t=g[a];s=g[u];var C=0,C=b(t,s)-r;if(0>C){for(var D=s=0,E=0;E<n.length;E++)E!==a&&g[E].hemisphere===h.hemisphere&&(g[E].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:D++);s=C/(s+D||1)*D;var D=-1*(C-s),J=E=0;"right"===h.hemisphere?(E=f(a,s),D=-1*(C-E),J=f(u,D),+J.toFixed(z)<
+D.toFixed(z)&&+E.toFixed(z)<=+s.toFixed(z)&&f(a,-(D-J))):(E=f(u,s),D=-1*(C-E),J=f(a,D),+J.toFixed(z)<+D.toFixed(z)&&+E.toFixed(z)<=+s.toFixed(z)&&f(u,-(D-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],w="pie"===k.type?0.7*A:0.8*A,u=y.x+w*Math.cos(h.midAngle),s=y.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],u=h.indexLabelTextBlock.measureText(),0!==u.height&&0!==u.width)u=u=0,"right"===h.hemisphere?(u=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
...
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[A];x._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:P[u.reversed?z.length-1-A:A]};"inside"===u.indexLabelPlacement&&(B[A]=A!==ba?u.reversed?P[A].x2-P[A].x1:P[A].x3-P[A].x4:P[A].x3-P[A].x6,20>B[A]&&(B[A]=A!==ba?u.reversed?P[A].x3-P[A].x4:P[A].x2-P[A].x1:P[A].x2-P[A].x1,B[A]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:B[A];if(t>B[A]||0>t)t=B[A];y[A]="inside"===u.indexLabelPlacement?P[A].height:!1;v=x.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)C={chart:x.options,dataSeries:u,dataPoint:b,total:v.total,percent:v.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,u,A):u.indexLabelFormatter?u.indexLabelFormatter(C):u.indexLabel?x.replaceKeywordsWithValue(u.indexLabel,b,u,A):b.label?
b.label:"";0>=n&&(n=0);1E3>t&&1E3-t<r&&(t+=1E3-t);R.roundRect||Ca(R);c=new ha(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:t,maxHeight:!1===y[A]?q?4.28571429*f:1.5*f:y[A],text:b,padding:ca});c.measureText();I.push({textBlock:c,id:u.reversed?D:A,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,k=N-T-U/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=z[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=N-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:
I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,u.reversed?(I[l].textBlock.y+I[l].height>ma+C&&(I[l].textBlock.y=ma+C-I[l].height),I[l].textBlock.y<qa-C&&(I[l].textBlock.y=qa-C)):(I[l].textBlock.y<ma-C&&(I[l].textBlock.y=ma-C),I[l].textBlock.y+I[l].height>qa+C&&(I[l].textBlock.y=qa+C-I[l].height))}function f(){var a,
b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>wa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<wa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,u.reversed?(I[e].textBlock.y+I[e].height>ma+C&&(I[e].textBlock.y=ma+C-I[e].height),I[e].textBlock.y<qa-C&&(I[e].textBlock.y=
qa-C)):(I[e].textBlock.y<ma-C&&(I[e].textBlock.y=ma-C),I[e].textBlock.y+I[e].height>qa+C&&(I[e].textBlock.y=qa+C-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ba?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ba?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=
p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,k;f=(S-Y+2*C)/n;k=n;for(var l,h=1;h<k;h++){e=h*f;for(var t=I.length-1;0<=t;t--)!I[t].isDirty&&(I[t].textBlock.y<e&&I[t].textBlock.y+I[t].height>e)&&(l=q(t),!(l>=I.length-1)&&I[t].textBlock.y+I[t].height+ca>I[l].textBlock.y&&(I[t].textBlock.y=I[t].textBlock.y+
I[t].height-e>e-I[t].textBlock.y?e+1:e-I[t].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=p(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(k=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+ca;){a=a||I[f].textBlock.y+I[f].height;k+=I[f].height;k+=ca;f=e;if(0>=f){f=0;k+=I[f].height;break}e=p(f);if(0>e){f=0;k+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+ca,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,l=(k=q(r)<P.length?I[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(k&&e+d+ca>+l.y.toFixed(6))&&(d=g.y+d+ca-l.y,
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<P.length?I[b].textBlock.y:u.reversed?ma+C:qa+C)-(0>a?u.reversed?qa-C:ma-C:I[a].textBlock.y+I[a].height+ca)}function m(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=X.indexOf(b)?(e=X.indexOf(b),X.splice(e,1)):(X.push(b),X=X.sort(function(a,b){return a-b})));if(0===X.length)l=ga;else{e=C*(1!=X.length||0!=X[0]&&X[0]!=P.length-1?2:1)/k();for(var t=0;t<P.length;t++){if(1==X.length&&0==X[0]){if(0===t){l.push(ga[t]);d=h;continue}}else 0===
t&&(d=-1*h);l.push(ga[t]+d);if(0<=X.indexOf(t)||t<P.length&&0<=X.indexOf(t+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var q={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;fa=!0;d.clearRect(y.x1,y.y1,y.x2-y.x1,y.y2-y.y1);d.fillStyle=a.backgroundColor;d.fillRect(y.x1,y.y1,y.width,y.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[z.length-1-b]:u.dataPoints[b];e.index=u.reversed?z.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)oa(d,P[e],u.fillOpacity);v(d);K&&("inside"!==u.indexLabelPlacement?n(d):f(),r(d));1<=c&&(fa=!1)},null,L.easing.easeOutQuart)}
function k(){for(var a=0,b=0;b<P.length-1;b++)(0<=X.indexOf(b)||0<=X.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(O(I[f].lineDashType,I[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}
function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=P.length&&a!=P.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<z.length;c++)if(P[c].y1<a&&P[c].y4>a){b=P[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function v(a){x.plotArea.layoutManager.reset();
...
J.fNg&&J.fNg(x)}var x=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],z=u.dataPoints,y=this.plotArea,C=0.025*y.width,D=0.01*y.width,A=0,F=y.height-2*C,E=Math.min(y.width-2*D,2.8*y.height),K=!1,H=0;H<z.length;H++)if(!K&&("undefined"!==typeof z[H].indexLabel&&null!==z[H].indexLabel&&0<z[H].indexLabel.toString().length)&&(K=!0),!K&&("undefined"!==typeof z[H].label&&null!==z[H].label&&0<z[H].label.toString().length)&&(K=!0),!K&&"function"===typeof u.indexLabelFormatter||
"function"===typeof z[H].indexLabelFormatter)K=!0;K=K||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&K||(D=(y.width-0.75*E)/2);var H=y.x1+D,N=y.x2-D,Y=y.y1+C,S=y.y2-C,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==z.length){var Q,G;a=75*E/100;var U=30*(N-a)/100;"funnel"===u.type?(Q=s(u.options.neckHeight)?0.35*F:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===
typeof Q&&Q.match(/%$/)?(Q=parseInt(Q),Q=Q*F/100):Q=parseInt(Q),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),Q>F?Q=F:0>=Q&&(Q=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=Q=0,u.reversed=u.reversed?!1:!0);var D=H+a/2,W=H,T=H+a,ma=u.reversed?S:Y,M=D-G/2,$=D+G/2,wa=u.reversed?Y+Q:S-Q,qa=u.reversed?Y:S;a=[];var D=[],P=[],E=[],Z=Y,ba,V=(wa-ma)/(M-W),da=-V,H="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==H){if(u.reversed)for(E.push(Z),G=H.length-
1;0<G;G--)Z+=H[G],E.push(Z);else for(G=0;G<H.length;G++)Z+=H[G],E.push(Z);if(u.reversed)for(G=0;G<H.length;G++)E[G]<wa?(a.push(M),D.push($),ba=G):(a.push((E[G]-ma+V*W)/V),D.push((E[G]-ma+da*T)/da));else for(G=0;G<H.length;G++)E[G]<wa?(a.push((E[G]-ma+V*W)/V),D.push((E[G]-ma+da*T)/da),ba=G):(a.push(M),D.push($));for(G=0;G<H.length-1;G++)Z=u.reversed?z[z.length-1-G].color?z[z.length-1-G].color:u._colorSet[(z.length-1-G)%u._colorSet.length]:z[G].color?z[G].color:u._colorSet[G%u._colorSet.length],G===
ba?P.push({x1:a[G],y1:E[G],x2:D[G],y2:E[G],x3:$,y3:wa,x4:D[G+1],y4:E[G+1],x5:a[G+1],y5:E[G+1],x6:M,y6:wa,id:G,height:E[G+1]-E[G],color:Z}):P.push({x1:a[G],y1:E[G],x2:D[G],y2:E[G],x3:D[G+1],y3:E[G+1],x4:a[G+1],y4:E[G+1],id:G,height:E[G+1]-E[G],color:Z});var ca=2,I=[],fa=!1,X=[],ga=[],H=!1;a=a=0;Da(X);for(G=0;G<z.length;G++)z[G].exploded&&(H=!0,u.reversed?X.push(z.length-1-G):X.push(G));R.clearRect(y.x1,y.y1,y.width,y.height);R.fillStyle=x.backgroundColor;R.fillRect(y.x1,y.y1,y.width,y.height);if(K&&
u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<z.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(N-a)/2,0==G&&(A=a),A>a&&(A=a));for(G=0;G<P.length;G++)P[G].x1+=A,P[G].x2+=A,P[G].x3+=A,P[G].x4+=A,P[G].x5&&(P[G].x5+=A,P[G].x6+=A),I[G].textBlock.x+=A}for(G=0;G<P.length;G++)A=P[G],oa(R,A,u.fillOpacity),ga.push(A.y1);v(R);K&&u.visible&&("inside"===u.indexLabelPlacement||x.animationEnabled||n(R),x.animationEnabled||r());if(!K)for(G=0;G<z.length;G++)A=u.dataPointIds[G],
a={id:A,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[u.reversed?z.length-1-G:G]},x._eventManager.objectMap[A]=a;!x.animationEnabled&&H?m(x,-1,0):x.animationEnabled&&!x.animatedRender&&m(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!fa&&!x.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?z.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?z[z.length-1-a].exploded=
z[z.length-1-a].exploded?!1:!0:z[a].exploded=z[a].exploded?!1:!0;m(x,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){L.fadeInAnimation(a,b);1<=a&&(m(x,-1,500),v(x.plotArea.ctx||x.ctx))},easingFunction:L.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
...
a?ca(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?ca(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};na(E,Z);E.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&
...
"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(p={items:[],width:0},k.push(p)):(p=k[z],z=(z+1)%k.length),this.height+=q.textBlock.height;q.textBlock.x=p.width;q.textBlock.y=0;p.width+=Math.round(q.textBlock.width+w+h+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=Math.max(p.width,this.width);r=q.textBlock.width+(w+h+("line"===q.chartType||"spline"===
...
this.ctx.moveTo(w,u+y);this.ctx.lineTo(w+v,u+y);this.ctx.stroke();this.errorMarkerColor.shift()}$.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);
this.ctx.restore();n=0<p?Math.max(n,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=R(q.id);this.ghostCtx.fillStyle=g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(s,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-s,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+
q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};na(H,Z);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(A)||s(F)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?F+u>m&&(h+=0<a[g].labelAngle?F+u-m-$:0):0>a[g].labelAngle?A-v<l&&A-v<a[g].viewportMinimum&&(E=l-(M+a[g].tickLength+x+A-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(F+u>m&&(h=F+u/2-m-$),A-v<l&&A-v<a[g].viewportMinimum&&(E=l-M-a[g].tickLength-x-A+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<h&&(m-=h))),n.panEnabled?T=s(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=T:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=T,h=Math.round(f.y2-T-e+G),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+z[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:m,y2:k-(T+e-z[g]-G),width:m-l,height:k-h}),G+=z[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+P+M),d[g].lineCoordinates.x2=
...
W-y[g]-S),x2:m,y2:k,width:m-l,height:k-h},S+=y[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)M=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+V+W<Math.max(M,p)?Math.max(M,p):f.y1+V+W),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-T-e-M),c[g].lineCoordinates={x1:l-U,y1:h,x2:m-U,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(x[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(x[g]+U),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),U+=x[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),M=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+V+W<Math.max(M,p)?Math.max(M,p):f.y1+V+W),M=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(T+e+M)),b[g].lineCoordinates=
...
[];A=[];E=[];v=[];F=[];u=[];N=[];for(O=[];4>w;){T=X=S=U=Z=M=W=e=R=Q=G=V=0;if(a&&0<a.length)for(E=[],g=X=0;g<a.length;g++)E.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),X+=E[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(E);if(d&&0<d.length)for(v=[],g=T=0;g<d.length;g++)v.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=v[g],W+=d[g]?d[g].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));O.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+X+e),m=Math.round(f.x2-T-W>n.width-10?n.width-10:f.x2-T-W),c[g].labelAutoFit&&!s(z)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,z):0===c[g].labelAngle?Math.max(l,z/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-y/2:0===c[g].labelAngle?m-y/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+X+e),m=Math.round(f.x2-T-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-W),b[g]&&b[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,x):0===b[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
...
2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;m=Math.round(f.x1+X+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-U):f.y2>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(m=0>c[M].labelAngle?Math.max(m,z):0===c[M].labelAngle?Math.max(m,z/2):m,l=
0>c[M].labelAngle||0===c[M].labelAngle?m-X:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(m=b[M].lineCoordinates.x1,l=m-X);a[g].lineCoordinates={x1:m-Q,y1:h,x2:m-Q,y2:k,height:Math.abs(k-h)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(E[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(E[g]+
Q),y1:h,x2:m,y2:k,width:m-l,height:k-h};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();Q+=E[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){M=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;m=Math.round(f.x2-T-W);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-U):f.y2>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(m=0>c[M].labelAngle?Math.max(m,z):0===c[M].labelAngle?Math.max(m,z/2):m,l=0>c[M].labelAngle||0===c[M].labelAngle?m-T:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&
...
!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=F[w-1][g]===F[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=u[w-1][g]===u[w][g]?!0:!1;else L=!0}if(r&&H&&J&&L)break;w++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
a.setSeconds(0),a.setMilliseconds(0));return a};na(T,Z);na(V,Z);V.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var d=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(Da(this.parent[this.optionsName]),d=this.parent.options[this.optionsName].indexOf(this.options));this.options="undefined"===typeof a?{}:a;this.parent.options[this.optionsName][d]=this.options}};V.prototype.render=function(a){if(0!==this.spacing||
0!==this.options.lineThickness&&("undefined"!==typeof this.options.lineThickness||0!==this.parent.lineThickness)){var d=this.ctx,c=this.ctx.globalAlpha;this.ctx=a||this.ctx;this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.ctx.clip();var b=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue),e=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue);this.ctx.strokeStyle=
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;R(this.id);var f,l,h,m,k,n;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(O(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,l=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,h=this.chart.plotArea.y2+
...
0,n=[];if("xySwapped"===this.chart.plotInfo.axisPlacement){var v=null;if("bottom"===this.parent._position||"top"===this.parent._position)r=this.parent.dataSeries[0].axisX.convertPixelToValue({y:d});else if("left"===this.parent._position||"right"===this.parent._position)r=this.parent.convertPixelToValue({y:d});for(var x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[x],null!==v.dataPoint.y&&v.dataSeries.visible&&
n.push(v));v=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));x=0;if("rangeBar"===n[0].dataSeries.type||"error"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[x].dataPoint.y[0])),u=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(var z=0;z<n[r].dataPoint.y.length;z++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else u=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,x=r);else if("stackedBar"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),y=u=0,r=x=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=0;z<n[r].dataPoint.y.length;z++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else y+=n[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(y)),u<v&&(v=u,x=r);else if("stackedBar100"===n[0].dataSeries.type)for(var v=
Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),C=y=u=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=0;z<n[r].dataPoint.y.length;z++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(a-this.parent.convertValueToPixel(C)),u<v&&(v=u,x=r);else for(v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=x=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=0;z<n[r].dataPoint.y.length;z++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,x=r);z=n[x];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[x].type||"error"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(z.dataPoint.y[0]));
for(r=u=0;r<z.dataPoint.y.length;r++)u=Math.abs(a-this.parent.convertValueToPixel(z.dataPoint.y[r])),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(z.dataPoint.y[b])<<0;this.value=z.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.y[b]}):s(this.options.label)?ca(c?c:z.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=u=0;for(r=x;0<=r;r--)y+=n[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(y)),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;this.value=y;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.y}):s(this.options.label)?
ca(c?c:z.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));C=y=u=0;for(r=x;0<=r;r--)y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(a-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<
0;this.value=C;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:C}):s(this.options.label)?ca(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(z.dataPoint.y)<<0,this.value=z.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.y}):
s(this.options.label)?ca(c?c:z.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/2)+2;k.y+k.height>this.chart.bounds.y2?k.y=
...
!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:z.dataPoint.x}):s(this.options.label)?Aa(z.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.x}):s(this.options.label)?ca(z.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=z.dataPoint.x;k.y=h+k.fontSize/2-k.measureText().height/
...
this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[x],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});z=n[0];b=e=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(z.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};C=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?
k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.x}):s(this.options.label)?Aa(z.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.x}):s(this.options.label)?ca(z.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
this.value=z.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width);k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!s(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(r=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));
for(x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[x],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});x=0;if("rangeColumn"===n[0].dataSeries.type||"rangeArea"===n[0].dataSeries.type||"error"===n[0].dataSeries.type||"rangeSplineArea"===n[0].dataSeries.type||"candlestick"===n[0].dataSeries.type||"ohlc"===n[0].dataSeries.type||
"boxAndWhisker"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y[0])),r=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=0;z<n[r].dataPoint.y.length;z++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,x=r);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=y=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=0;z<n[r].dataPoint.y.length;z++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else y+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(y)),u<v&&(v=u,x=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=C=y=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=
0;z<n[r].dataPoint.y.length;z++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(d-this.parent.convertValueToPixel(C)),u<v&&(v=u,x=r);else for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(z=0;z<n[r].dataPoint.y.length;z++)u=
Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[z])),u<v&&(v=u,x=r);else u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,x=r);z=n[x];b=0;if("rangeColumn"===this.parent.dataSeries[x].type||"rangeArea"===this.parent.dataSeries[x].type||"error"===this.parent.dataSeries[x].type||"rangeSplineArea"===this.parent.dataSeries[x].type||"candlestick"===this.parent.dataSeries[x].type||"ohlc"===this.parent.dataSeries[x].type||"boxAndWhisker"===this.parent.dataSeries[x].type){v=
Math.abs(d-this.parent.convertValueToPixel(z.dataPoint.y[0]));for(r=u=0;r<z.dataPoint.y.length;r++)u=Math.abs(d-this.parent.convertValueToPixel(z.dataPoint.y[r])),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(z.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataPoint.y[b]}):s(this.options.label)?ca(c?c:z.dataPoint.y[b],this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=z.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[x].type||"stackedArea"===this.parent.dataSeries[x].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=u=0;for(r=x;0<=r;r--)y+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(y)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:z.dataPoint.y}):s(this.options.label)?ca(c?c:z.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[x].type||"stackedArea100"===this.parent.dataSeries[x].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=u=0;for(r=x;0<=r;r--)y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),
u=Math.abs(d-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:C}):s(this.options.label)?ca(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=C}else"waterfall"===this.parent.dataSeries[x].type?(w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum)<<
0)+0.5:this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z.dataSeries.dataPointEOs[z.index].cumulativeSum}):s(this.options.label)?ca(c?c:z.dataSeries.dataPointEOs[z.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=z.dataSeries.dataPointEOs[z.index].cumulativeSum):(w=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(z.dataPoint.y)<<
0)+0.5:s(a)?d:this.parent.convertValueToPixel(z.dataPoint.y)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:z.dataPoint.y}):s(this.options.label)?ca(c?c:z.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=z.dataPoint.y);f=h=w;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};k.y=h+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?
...
this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?Aa(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?ca(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label);k.y=d+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=
this.parent.lineCoordinates.x1-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}else{if("bottom"===this.parent._position||"top"===this.parent._position)k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?ca(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label,k.x=b-k.measureText().width/
...
axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?Aa(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):s(this.options.label)?ca(c?c:this.parent.convertPixelToValue(a),
...
this.parent.convertPixelToValue(w);this._textBlock=k;s(c)||this.renderLabel();q.globalAlpha=g};ba.prototype.renderLabel=function(){s(this._textBlock)||(s(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};na(W,Z);W.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class",
...
content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};W.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),this.chart.clearedOverlayedCanvas="toolTip";d.save();var c=this.chart.plotArea,
...
f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),$.drawMarkers([f]))):"bubble"===b.type?(f=b.getMarkerProperties(h,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=e.size,f.color="white",f.borderColor="white",d.globalAlpha=0.3,$.drawMarkers([f]),d.globalAlpha=1):"column"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"bar"===b.type||"rangeBar"===b.type||"stackedBar"===b.type||"stackedBar100"===b.type||"rangeColumn"===b.type||"waterfall"===b.type?da(d,e.x1,e.y1,e.x2,e.y2,
"white",0,null,!1,!1,!1,!1,0.3):"pie"===b.type||"doughnut"===b.type?ga(d,e.center,e.radius,"white",b.type,e.startAngle,e.endAngle,0.3,e.percentInnerRadius):"funnel"===b.type||"pyramid"===b.type?oa(d,e.funnelSection,0.3,"white"):"candlestick"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,Math.min(e.y2,e.y3)),d.lineTo(e.x3-b,Math.min(e.y1,e.y4)),d.stroke(),d.beginPath(),d.moveTo(e.x3-b,Math.max(e.y1,e.y4)),d.lineTo(e.x3-
b,Math.max(e.y2,e.y3)),d.stroke(),da(d,e.x1,Math.min(e.y1,e.y4),e.x2,Math.max(e.y1,e.y4),"transparent",2*e.borderThickness,e.color,!1,!1,!1,!1),d.globalAlpha=1):"ohlc"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,e.y2),d.lineTo(e.x3-b,e.y3),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y1),d.lineTo(e.x1,e.y1),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4),d.lineTo(e.x2,e.y4),d.stroke(),d.globalAlpha=1):"boxAndWhisker"===
b.type?(d.save(),d.globalAlpha=1,d.strokeStyle=e.stemColor,d.lineWidth=2*e.stemThickness,0<e.stemThickness&&(d.beginPath(),d.moveTo(e.x3,e.y2+e.borderThickness/2),d.lineTo(e.x3,e.y1+e.whiskerThickness/2),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4-e.whiskerThickness/2),d.lineTo(e.x3,e.y3-e.borderThickness/2),d.stroke()),d.beginPath(),da(d,e.x1-e.borderThickness/2,Math.max(e.y2+e.borderThickness/2,e.y3+e.borderThickness/2),e.x2+e.borderThickness/2,Math.min(e.y2-e.borderThickness/2,e.y3-e.borderThickness/
...
a+"s ease-out 0s, bottom "+a+"s ease-out 0s"};fa.prototype.reset=function(){this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.eventObjects=[];w&&(this.ghostCtx.clearRect(0,0,this.chart.width,this.chart.height),this.ghostCtx.beginPath())};fa.prototype.getNewObjectTrackingId=function(){return++this.lastObjectId};fa.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var d=[],c=Oa(a),b=null;if((b=
